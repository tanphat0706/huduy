            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group col-md-12 col-xs-12" style="float: left;">
                        <label for="name">{{ trans('carousel.image') }}</label><span class="required">*</span>
                        <div>
                            <img class="img-responsive" style="width:100%;height: 215px"
                                 src="{{asset('images/carousel_img/'.$carou->image)}}" id="output">
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label for="name">{{ trans('carousel.link') }}</label>
                        <span class="required">*</span>
                        {!!Form::text('link', null,array('class' => 'form-control formwidth', 'autocomplete' => 'off')) !!}
                    </div>
                    <div class="form-group">
